export function startCommand(ctx) {
    ctx.reply(
        ...
        "🧡 А воплотить понравившуюся идею всегда можно в нашем центре \"Тепло\"! Переходи в нашу группу [ВК](https://vk.com/mp_teplo) или [Телеграм](https://t.me/teplo_mc), выбирай удобное время и записывайся!"
        , { parse_mode: "Markdown" }
    );
}
